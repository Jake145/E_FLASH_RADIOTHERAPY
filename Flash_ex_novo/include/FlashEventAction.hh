...
class FlashEventAction : public G4UserEventAction //definisco la Event Action che eredita da 								//G4UserEventAction
{
  public:
    FlashEventAction(FlashRunAction* runAction); //definisco il costruttore che ha in argomento un 							//puntatore runAction
